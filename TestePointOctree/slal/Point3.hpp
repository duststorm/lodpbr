...
*/      
      ...
      public:
           ...
           */
          template <class T>
          friend inline const Vector3<T> operator- (const Point3<T>& p,const Point3<T>& q);  
          /*!@brief operator+
       ...
       */                    
      template<class Real>
      inline const Vector3<Real> operator- (const Point3<Real>& p, const Point3<Real>& q)  
      {
...
//    	   /*!
//    	    * Share memory with abscissas atributes and the XYZ Array.
//    	    * The Struct has the same size of the Array.
//    	    */
//    	   union
//    	   {
//    		   struct
...
//    	   };
//
//    	   Point3 ( const Real& x, const Real& y, const Real& z ): mX(x), mY(y), mZ(z) {};
//
//    	   template < typename P >
//    	   Point3 (const P* p)
//    	   {
...
//    	   };
//
//    	   Point3 ( const Vector3<Real>& u) : mX(u.mX), mY(u.mY), mZ(u.mZ) {};
//
//    	   Point3 ( const Point3<Real>& p)  : mX(p.mX), mY(p.mY), mZ(p.mZ) {};
//
//
//    	   template < typename C >
//    	   inline void setRGB ( const C* pC)
...
//    	    */
//
//    	   Point3< Real >& operator+= (  const Point3<Real>& u )
//    	   {
//    		   this->mX += u.x();
//    		   this->mY += u.y();
//    		   this->mZ += u.z();
...
//    	    */                    
//
//    	   friend inline const Vector3<Real> operator- (const Point3<Real>& p, const Point3<Real>& q)  
//    	   {
//    		   return ( Vector3<Real>( p.mX - q.mX,
//    				   p.mY - q.mY,
//    				   p.mZ - q.mZ)
...
//
//
//    	   friend inline  Point3<Real> operator- (const Real& factor,const Point3<Real>& p )  
//    	   {
//    		   return ( Point3<Real> ( factor - p.mX ,
//    				   factor - p.mY ,
//    				   factor - p.mZ  )
...
//
//
//    	   friend inline  Point3<Real> operator- (const Point3<Real>& p, const Real& factor )  
//    	   {
//    		   return ( Point3<Real> ( p.mX - factor,
//    				   p.mY - factor,
//    				   p.mZ - factor )
...
//    	    */
//
//    	   friend inline Point3<Real> operator- (const Point3<Real>& p, const Vector3<Real>& u)  
//    	   {
//    		   return ( Point3<Real>( p.mX - u.mX,
//    				   p.mY - u.mY,
//    				   p.mZ - u.mZ )
...
//    	    */
//
//    	   friend inline Point3<Real> operator- (const Vector3<Real>& u,const Point3<Real>& p )  
//    	   {
//
//    		   return ( Point3<Real>( u.mX - p.mX,
//    				   u.mY - p.mY,
