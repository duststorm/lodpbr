...
template <class Real>
double distance(const Celer::Point3<Real>& q, const Celer::Point3<Real>& p)
{
    double a, b;
    a = (p[0] - q[0]);
    b = a * a;
...
///
template <class Real>
class Box_3 : public Celer::BoundingBox3<Real> {

public:

typedef typename Celer::Point3<Real> Point3;
typedef typename Celer::BoundingBox3<Real> Bbox3;
