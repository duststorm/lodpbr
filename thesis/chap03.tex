...
O objetivo de um estrutura de partição do espaço é criar uma indexação do
espaço, ou seja, decompo-ló em células e provê uma relação entre estas células
e o espaço ocupado por um objeto \cite{Samet2005}.
