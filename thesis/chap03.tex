...
processar modelos grandes. Diversos métodos de simplificação,
...
No caso específico de nuvens de pontos, exitem algumas classes de algoritmos disponíveis: baseados em representações hierárquicas, não hierárquicas ou em cluster de pontos. Nesta seção as estruturas mais comuns serão introduzidas: \textit{Octree} (seção
...
\caption{ Círculo de busca em uma \textit{kd-tree} $2D$. Células em destaque
