...
foi realizada até que os nós folhas armaze $1$ ponto. A estrutura em árvore
...
de interesse são computadas subindo na hierarquiae e depois testando todos os
filhos destas células contra a esfera. Pontos que estão alocados nestas células
são candidatos ao teste de interseção com a esfera de busca. Os pontos que estão
...
\ref{sec:qspalt}. Diferentimente de métodos de partição de dados para indexação
...
pararelos aos eixos coordenados. Este plano é determinado como o plano que
divide a caixa envolvente ao longo da sua maior extensão como
ilustado na Figura \ref{fig:BVH}. Para cada subconjunto uma esfera é computada,
...
processamento rápido não hierarquico da GPU. Assim, há um conversão da estrutura
