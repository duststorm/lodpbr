...
O objetivo de um estrutura de partição do espaço é criar é indexar o espaço, ou
seja, decompo-ló em células e provê uma relação entre estas células e o espaço
ocupado por um objeto \cite{S}
