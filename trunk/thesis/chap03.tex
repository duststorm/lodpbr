...
modelagem podem ser realizadas com a adição ou remoção de pontos apenas, mas
informações de vizinhança, que muitas vezes é necessária, não é explicitamente presente.

Este capítulo apresenta algumas estruturas de dados para tratar nuvem de
pontos bem como alguns trabalhos que estenderam algumas destas estruturas
visando renderização interativa.
...
as BVHs não são obrigatoriamente uma partição baseadas no espaço. Sendo assim, algumas
...
e seus filhos ignorados. O sistema será descrito com mais detalhes nas
seções seguintes.
