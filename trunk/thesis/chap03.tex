...
No caso específico de nuvens de pontos, exitem algumas classes de algoritmos disponíveis: 
...
intersetam uma esfera de raio $r$ centrada no ponto (veja \ref{fig:kdSphere}). As células
...
para baixo, similiar a uma \textit{octree} ou \textit{kd-tree}.
