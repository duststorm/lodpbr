...
\ref{cap02:sec:orientado} será apresentada a primitiva em si. Por último discutiremos 
...
momento permitindo a unificação dos algoritmos de visualização. Para permitir a 
reconstrução de uma superfície contínua, os pontos são incrementados com valores 
...
visualização. Xu et al.~\cite{Xu2004} apresentaram uma técnica de renderização sem
...
os 
$k$-vizinhos de uma nuvem de pontos. Dados os $k$ vizinhos
...
Kobbelt e Botsch \cite{Kobbelt2004}. Nesta dissertação usaremos \textit{splats} elípticos, sendo
