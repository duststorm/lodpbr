...
**
** Created: Wed May 19 19:44:14 2010
...
static const char qt_meta_stringdata_GLWidget[] = {
    "GLWidget\0\0color\0setBackgroundColor(QColor)\0"
    "setForegroundColor(QColor)\0"
};
...
int GLWidget::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: setBackgroundColor((*reinterpret_cast< const QColor(*)>(_a[1]))); break;
        case 1: setForegroundColor((*reinterpret_cast< const QColor(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 2;
    }
