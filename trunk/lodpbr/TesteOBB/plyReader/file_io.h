...
void normalize (list<Surfel> * surfels) {
...
bool loadSls (const char * filename, list<Surfel> *surfels) {  
...
/// @return 1 if file read with success, 0 otherwise
bool loadNormals (const char * filename, list<Surfel> *surfels) {  
  std::ifstream input (filename);
...
void readPly (const char *filename, list<Surfel> *surfels) {
...
int readPoints(int argc, char **argv, list<Surfel> *surfels) {
