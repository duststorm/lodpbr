...
public:
  ...
  const KdTreeNode* Search (SurfelPtr p)
  {
	  if (IsLeaf())
	  {
		  return this;
  ...
  Real InsertNeighbor (const SurfelPtr& surfelPtr, Real dist, KNearestMap& pKNearest, unsigned int k) const
  {
	  pKNearest.insert ( KNearestPair (dist, surfelPtr) );
  ...
  int KNearestLocalNeighbors (const SurfelPtr& p, KNearestMap& pKNearest, unsigned int k) const
  {
	  int comps = 0;
	  Real minDist;
  ...
  /// @param k_nearest Ordered set of nearest neighbors
  /// @param k Number of nearest neighbors to find
  int KNearestNeighbors (const SurfelPtr& p, KNearestMap& pKNearest, unsigned int k) const
  {
	  int comps = 0;
  ...
  void Insert (int level, const SurfelPtr& p)
  {
...
//	  return  sum + PtrList.size();
  ...
  const SurfelPtr Element (int id) const
  {
    return mListPtr[id];
  }
 ...
 // ====================================== Only for Clustering ============================================//
  ...
  Real Cost (SurfelPtr& p,SurfelPtr& q)
  {
  ...
  /// @param k Number of nearest neighbors to find
  /// @return Number of distance comparisons made
  int KNearestLocalNeighborsClustering ( SurfelPtr& p, KNearestMap& pKNearest, unsigned int k)
  {
	  int comps = 0;
	  Real minDist;
  ...
  /// @param k_nearest Ordered set of nearest neighbors
  /// @param k Number of nearest neighbors to find
  int KNearestNeighborsClustering ( SurfelPtr& p, KNearestMap& pKNearest, unsigned int k)
  {
	  int comps = 0;
	  // Computes the distance to this node's itens
